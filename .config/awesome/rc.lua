...
vicious.register(thermalwidget, vicious.widgets.thermal, " $1°C ", 10, "thermal_zone0")
...
vicious.register(memwidget, vicious.widgets.mem, " $2M $6M ", 13)
...
function floatingbutton(c)
    local widget = awful.titlebar.widget.button(c, "floating", awful.client.object.get_floating, function() end)
    return widget
end
...
function stickybutton(c)
    local widget = awful.titlebar.widget.button(c, "sticky", function(cl)
        return cl.sticky
    end, function(cl, state)
        -- cl.sticky = not state
    end)
...
function ontopbutton(c)
    local widget = awful.titlebar.widget.button(c, "ontop", function(cl)
        return cl.ontop
    end, function(cl, state)
        -- cl.ontop = not state
    end)
